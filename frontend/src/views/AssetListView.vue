...
const assets = ref<Asset[]>([]); const loading = ref(false); const total = ref(0); const page = ref(1); const status = ref(''); const action = ref<AssetAction | null>(null); const selected = ref<Asset | null>(null)
