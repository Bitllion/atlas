...
export const assetApi = {
  ...
  transfer: (id: string, targetOrganizationId: string, notes: string, version: number) => apiClient.put<Asset>(`/assets/${id}/transfer`, { target_organization_id: targetOrganizationId, notes: notes || null, version }),
  completeTransfer: (id: string, inventoryLocationId: string, version: number) => apiClient.put<Asset>(`/assets/${id}/complete-transfer`, { inventory_location_id: inventoryLocationId, version }),
  retire: (id: string, reason: string, disposition: 'RMA' | 'SCRAPPED' | 'RETURNED_TO_VENDOR', version: number) => apiClient.put<Asset>(`/assets/${id}/retire`, { reason, disposition, version }),
  recover: (id: string, reason: string, version: number) => apiClient.put<Asset>(`/assets/${id}/recover`, { reason, version }),
