...
@router.get("/objects/{object_id}", response_model=ObjectDetail, tags=["objects"])
...
@router.get("/objects/{object_id}/history", tags=["objects"])
...
@router.get("/object-types", tags=["types"])
...
@router.get("/relationship-types", tags=["types"])
